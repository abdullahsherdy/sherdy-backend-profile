    ...
    <div className="container mx-auto">
      ...
      <AnimatedSection animation="fade-up" delay={200}>
        <div className="max-w-2xl mx-auto mb-12">
          <h3 className="font-display text-xl font-semibold text-center mb-8 text-primary">Specialization</h3>
      ...
      <div className="max-w-4xl mx-auto">
        <h3 className="font-display text-xl font-semibold text-center mb-8 text-primary">Full toolbox</h3>
