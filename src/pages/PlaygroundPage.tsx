...
const PlaygroundPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300">
      ...
      />
      <Navbar isDarkMode={isDarkMode} toggleDarkMode={toggleDarkMode} activeSection="playground" />
      <PageTransition>
        <main className="container mx-auto flex min-h-[calc(100vh-4rem)] flex-col px-4 pt-28 pb-12">
